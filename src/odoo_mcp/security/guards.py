...
from .policy import DEFAULT_DENIED_MODELS, get_allowed_models, get_denied_write_fields


def guard_model_access(model_name: str, client=None, sender_id: int | None = None) -> None:
